...
class LocationService {
  static final shared = LocationService();
  ...
  Future<Position> determinePosition() async {
    ...
    if (!serviceEnabled) {
      ...
      scaffoldMessenger.currentState!.showSnackBar(const SnackBar(
          content: Text("Location services are disabled."), backgroundColor: Colors.amber));
    ...
    if (permission == LocationPermission.denied) {
      ...
      if (permission == LocationPermission.denied) {
        ...
        scaffoldMessenger.currentState!.showSnackBar(const SnackBar(
            content: Text("Location permissions are denied"), backgroundColor: Colors.red));
